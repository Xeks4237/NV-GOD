...
vim.keymap.set('n', '<C-w><C-Up>', '<cmd>resize -2<CR>', { desc = 'Vertical Resize Up' })
vim.keymap.set('n', '<C-w><C-Down>', '<cmd>resize +2<CR>', { desc = 'Vertical Resize Down' })
vim.keymap.set('n', '<C-w><C-Left>', '<cmd>vertical resize -2<CR>', { desc = 'Horizontal Resize' })
vim.keymap.set('n', '<C-w><C-Right>', '<cmd>vertical resize +2<CR>', { desc = 'Horizontal Resize' })
