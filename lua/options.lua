...
vim.o.mouse = "a" -- Enable mouse, Can be usefull to resize splits
...
vim.o.showmode = true -- things like -- INSERT --
...
vim.diagnostic.config { virtual_text = true } -- enables floating vistual text for code diagnoctics
